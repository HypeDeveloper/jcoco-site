        ...
        <>
            <section id='Hero1'>
                <div className="imgHero">
                    <div className="moveLink">
                        <Link to={'/umuAsa'}><img src={round} alt="" /></Link>
                    </div>
                    <img src={heroImg} alt="" />
                </div>
                <div className="socials_home">
                    <div className="textsocial">
                    <h3>Princess Jecoco Socials</h3>
                    </div>
                ...
                <div className="shopInfo">
                    <div className="shopTop_info">
                        ...
                        <p className="text text-width-500 pad-b-2">
                            Shop for all excluive T-shirt from my brand
                        </p>
            ...
            <section id='youtube-hero'>
                <div className="youtube-info">
                    ...
                    <p className="text">
                        Looking for the best Lifestyle gist and family planning advise, get it all and more on my channel
                    </p>
